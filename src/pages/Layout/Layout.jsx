...
import featured1 from "../../assets/images/Featured_img/featured1.png";
import featured2 from "../../assets/images/Featured_img/featured2.png";
import featured3 from "../../assets/images/Featured_img/featured3.png";
import featured4 from "../../assets/images/Featured_img/featured4.png";
import featured5 from "../../assets/images/Featured_img/featured5.png";
import featured6 from "../../assets/images/Featured_img/featured6.png";
          ...
          <div className="container">
            <div className="wrapper">
              ...
              <ul>
                <li>
                  <div>
                    <img src={featured1} alt="card-image" />
                  </div>
                  <div className="card_body">
                    ...
                    <h3>
                      Vue.js form 0 to PRO course . Vue3 , Pinia , Design
                      pattrens ...
                    </h3>
                ...
                <li>
                  <div>
                    <img src={featured2} alt="card-image" />
                  </div>
                  <div className="card_body">
                    <div className="st-counter">
                      <p>5,957 Students</p>
                    ...
                    <h3>
                      React.js form 0 to PRO course . React , Redux , Design
                      pattrens ...
                    </h3>
                    <div className="price_box">
                      <p>$45.99</p>
                ...
                <li>
                  <div>
                    <img src={featured3} alt="card-image" />
                  </div>
                  <div className="card_body">
                    <div className="st-counter">
                      <p>5,957 Students</p>
                    ...
                    <h3>
                      Hozirgi yoshlarga eslatmalar . Bugun qiyin , ertaga sinov
                      , o’qishdan ...
                    </h3>
                    <div className="price_box">
                      <p>$33.99</p>
                ...
                <li>
                  <div>
                    <img src={featured4} alt="card-image" />
                  </div>
                  <div className="card_body">
                    <div className="st-counter">
                      <p>5,957 Students</p>
                ...
                <li>
                  <div>
                    <img src={featured5} alt="card-image" />
                  </div>
                  <div className="card_body">
                    <div className="st-counter">
                      <p>5,957 Students</p>
                ...
                <li>
                  <div>
                    <img src={featured6} alt="card-image" />
                  </div>
                  <div className="card_body">
                    <div className="st-counter">
                      <p>5,957 Students</p>
